...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    var window: UIWindow?
    var loggedInRootNav: UINavigationController?
    ...
    func setRootViewController() {
        ...
        if UserDefaults.standard.string(forKey: "uid") != nil {
            ...
            //loggedInRootNav = window?.rootViewController as? UINavigationController
            ...
            let homeViewController = newStoryBoard.instantiateViewController(identifier: Constants.Storyboard.homeViewController) as? TripListViewController
            */
            window?.rootViewController = nav
            //this shows home as the new view controller
            window?.makeKeyAndVisible()
            
            print("Here in currentUserSettingRoot")
        }
        else{
